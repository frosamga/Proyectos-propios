 ...
 * @author Alan
 *
 *Esta clase permite recorrer la página web canalcocina.com y obtener las imagenes y recetas de todas las paginas.
 *
 *AUN NO ESTA COMPLETADO PERO MUCHAS FUNCIONES HACEN LO QUE DEBERIAN.
 */
public class Lector {
	private boolean hayLista = false;
	private String titulo = null, foto = null;
	private String FICHERO = "DONDE VA EL FICHERO";

	public Lector() {
		Properties props = System.getProperties();
		props.put("http.proxyPort", "NUMERO EN INT"); // proxy port
		props.put("http.proxyHost", "PROXY UMA"); // the proxy server
															// name or IP
		props.put("http.proxySet", "true");
	}

	//Permite guardar las fotos mediante la url que se le pasa y decirle a donde guardarlas.
	...
	//Le pasas la URL del sitio terminado en / y luego el numero de paginas que quieres que lea
